...
if(isset($_POST['year']) && isset($_POST['month']))
{
   ...
   /*  echo "$year";
    echo "$month";
 */
    $result=mysql_query("select * from comp2 where YEAR(date) = $year AND MONTH(date) = $month");
    ...
    <th bgcolor=lightgreen>Evidence</th>
     ...
     ?>
      ...
      <?php
        ...
        top:78px; font-size:35px;'>No Complaints found on the Specified year and month</h1></div>";
    }
}
?>
