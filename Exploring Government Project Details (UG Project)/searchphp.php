...
<!-- <form action="search.php" method="GET">
   ...
   <?php
     ...
     $res = mysql_query("select * from updatepro2 where Id='$search'");
   ...
   <center>
      ...
      <?php
        ...
        echo "<div id='elsebox'><h1 class='error-message' style='color:white;'>No Project found on the selected Project ID</h1></div>";
    }
     ?>
   </center>
</body>
