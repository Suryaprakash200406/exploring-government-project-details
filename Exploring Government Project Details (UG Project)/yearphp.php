...
if(isset($_POST['year']) && isset($_POST['month']))
{
   ...
   /*  echo "$year";
    echo "$month";
 */
    $result=mysql_query("select * from updatepro2 where YEAR(Time_period) = $year AND MONTH(Time_period) = $month");
    ...
    if(mysql_num_rows($result) > 0 )
    {
      ...
      <?php
        ...
        top:78px; font-size:35px;'>No Projects found on the Specified year and month</h1></div>";
    }
}
?>
